        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="wrap d-md-flex">
                    <div class="img" style="background-image: url('assets/img/bg_login.jpg');">
                    </div>
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="query.php" class="signin-form" method="post">
                            ...
                            <div class="form-group mb-3">
                                <label class="label" style="color: red">*Invalid login details*</label>
                            </div>
                            <?php } ?>
